                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="card">
                            <div class="header">
                                <div class="pull-left">
                                <h4 class="title">Agenda Editor</h4>
                                </div>
                                ...
                                <form action="post" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Judul Agenda</p>
                                                <input type="text" id="title_id" class="form-control" name="nama" value="<?php echo $u->nama;?>" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Tempat</p>
                                                <input type="text" id="title_id" class="form-control" name="tempat" value="<?php echo $u->tempat;?>" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Penyelenggara</p>
                                                <input type="text" id="title_id" class="form-control" name="penyelenggara" value="<?php echo $u->penyelenggara;?>" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Isi Postingan</p>
                                                    <textarea name="isi" class="post" id="content_id" rows="8" cols="40"><?php echo $u->isi;?></textarea><br>
                                            </div>
                                        </div>
                                    </div>
