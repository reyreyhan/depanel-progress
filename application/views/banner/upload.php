                                ...
                                <form action="post" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Judul</p>
                                                <input type="text" id="title_id" class="form-control" name="judul" value="" p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Posisi</p>
                                                <input type="text" id="title_id" class="form-control" name="posisi" value="" >
                                            </div>
                                        </div>
                                    </div>
