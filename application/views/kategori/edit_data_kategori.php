                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="card">
                            <div class="header">
                                <div class="pull-left">
                                        <h4 class="title">Kategori Editor</h4>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Nama Kategori</p>
                                                <input type="text" id="title_id" class="form-control" name="nama_kategori" value="<?php echo $u->nama_kategori ?>" placeholder="Masukkan Nama">
                                            </div>
                                        </div>
                                    </div>
