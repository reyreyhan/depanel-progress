				...
				<div id="content" class="ui segment grid">
					...
					<div id="inner-content" class="eleven wide column">
						...
						<div class="content-desc">
							<p><?php echo $post->isi_en; ?> </p>

							<div class="fb-like" data-href="<?php echo base_url('news/post/'. $post->url_id); ?>" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
					...
					<div id="side-content" class="five wide column">
						...
						<a href="<?php echo base_url('/news/post/'.$post->url_id); ?>"><i class="flag icon"></i></a>
						...
						?>
						<br>
						<span class="costum2">Change to Indonesia</span>
						<br>
							<a href="<?php echo base_url('/news/post/'.$post->url_id); ?>">
									<span class="tag tag1">Indonesia</span>
							</a>
					</div>
				</div>
			<?php } ?>
