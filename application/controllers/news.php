...
class News extends CI_Controller {
    ...
    public function post($slug=NULL) {
		...
		public function posten($slug=NULL) {

        $where = array('url_en' => $slug);
        $data['post'] = $this->m_depanel_post->detail_data_post_blog($where,'post')->result();
        ...
        $this->load->view('welcome/blogposten',$data);
 ...
 //       $where = array('id' => $id);
		...
		public function pdf($slug=NULL) {
			...
			$this->load->view('welcome/pdf',$data);
			...
			//$this->dompdf->DOMPDF_ENABLE_REMOTE(true);
			$this->dompdf->render();
			$this->dompdf->stream($slug .".pdf");
    ...
    public function cari($cari=NULL) {
        ...
        //$this->load->view('welcome/pencarian',$data);
				$this->load->view('welcome/cari2',$data);
