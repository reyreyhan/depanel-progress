                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="card">
                            <div class="header">
                                <div class="pull-left">
                                        <h4 class="title">Newsflash Editor</h4>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="content">
                                <form action="post" method="post">
                                    <?php foreach($newsflash as $u){ ?>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Judul</p>
                                                <input type="text" id="title_id" class="form-control" name="judul" value="<?php echo $u->judul ?>" placeholder="Isi Judul Newsflash">
                                            </div>
                                        </div>
                                    </div>
                                   ...
                                   <!--      <input type="text" id="title_id" class="form-control" name="keterangan" value="<?php // echo $u->keterangan ?>" placeholder="Isi Keterangan">
                                    --><br>
                                   <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>URL</p>
                                                <input type="text" id="title_id" class="form-control" name="url" value="<?php echo $u->url ?>" placeholder="Isi Url Jika Ada">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Posisi</p>
                                                <input type="text" id="title_id" class="form-control" name="posisi" value="<?php echo $u->posisi ?>" placeholder="???????">
                                            </div>
                                        </div>
                                    </div>
