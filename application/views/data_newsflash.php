        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo site_url('upload/hasil_search');?>" method = "post">
                    ...
                    <div class="col-md-12">
                      <h2 class="title">Data Newsflash</h2>
                      <div class="row">
                        <div class="col-md-12">
                          <div class="card">
                              <div class="header">
                                  ...
                                  ?>
                                          <tr>
                                              ...
                                              <td>
                                                ...
                                                <img height="50" width="50" src="<?php echo base_url(). "assets/uploads/newsflash/".$u->gambar ?>">
                                                  </a>
                                              </td>
                                              ...
                                              <td>
                                                ...
                                                <a href="<?php echo base_url('upload/hapus/'.$u->id); ?>" onclick="javascript: return confirm('Yakin Hapus <?php echo $u->judul ?>?')"><button type="button" class="btn btn-danger btn-fill btn-sm" name="button">Hapus</button></a>
                                              </td>
                                          </tr>
                                  <?php } ?>
                                      </tbody>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Input Data Newsflash</h4>
        </div>
        <div class="modal-body">
    <?php echo form_open_multipart('/upload/data'); ?>

                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Judul</p>
                                                <input type="text" id="title_id" class="form-control" name="judul" value="" placeholder="Judul Newsflash" id="InputName" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Keterangan</p>
                                                    <textarea id="InputName" class="form-control" name="keterangan" class="post" id="content_id" rows="8" cols="40" placeholder="Keterangan Newsflash"></textarea><br>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Url</p>
                                                <input type="text" id="title_id" class="form-control" name="url" value="" placeholder="Url Newsflash">
                                            </div>
                                        </div>
                                    </div>
