                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="card">
                            <div class="header">
                                <div class="pull-left">
                                        <h4 class="title">Input Kategori PENS Post</h4>
                                </div>
                                ...
                                <form action="post" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Nama Anggota</p>
                                                <input type="text" id="title_id" class="form-control" name="nama" value="" placeholder="Isi Nama Anggota">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Email</p>
                                                <input type="text" id="title_id" class="form-control" name="email" value="" placeholder="Isi Nama Email">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Password</p>
                                                <input type="text" id="title_id" class="form-control" name="password" value="" placeholder="Isi Password">
                                            </div>
                                        </div>
                                    </div>                                      
