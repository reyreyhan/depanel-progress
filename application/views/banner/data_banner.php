        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo site_url('banner/hasil_search');?>" method = "post">
                                  ...
                                  ?>
                                          <tr>
                                              ...
                                              <td>
                                                ...
                                                <img height="50" width="50" src="<?php echo base_url(). "assets/uploads/banner/".$u->gambar ?>">
                                                  </a>
                                              </td>
                                              ...
                                              <td>
                                                ...
                                                <a href="<?php echo base_url('banner/hapus/'.$u->id); ?>" onclick="javascript: return confirm('Yakin Hapus <?php echo $u->judul ?>?')"><button type="button" class="btn btn-danger btn-fill btn-sm" name="button">Hapus</button></a>
                                              </td>
<!--                                               <td>
...
<!-- Modal -->
  <div class="modal fade" id="wkwk" role="dialog">
    ...
    <?php echo form_open_multipart('/banner/data'); ?>

<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Judul</p>
                                                <input type="text" id="title_id" class="form-control" name="judul" d="InputName" placeholder="Judul Banner" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Keterangan</p>
                                                    <textarea id="InputName" class="form-control" name="keterangan" class="post" id="content_id" rows="8" cols="40" placeholder="Keterangan Banner"></textarea><br>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <p>Url</p>
                                                <input type="text" id="title_id" class="form-control" name="url" value="" placeholder="Url Banner">
                                            </div>
                                        </div>
                                    </div>
